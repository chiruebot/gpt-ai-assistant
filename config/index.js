...
const config = Object.freeze({
  ...
  AZURE_OPENAI_TIMEOUT: env.AZURE_OPENAI_TIMEOUT || env.APP_API_TIMEOUT,
  AZURE_OPENAI_API_KEY: env.AZURE_OPENAI_API_KEY || '1c90732a62b342dfa4f811f7f2c30855',
  AZURE_OPENAI_COMPLETION_MODEL: env.AZURE_OPENAI_COMPLETION_MODEL || 'gpt-3.5-turbo',
  AZURE_OPENAI_COMPLETION_TEMPERATURE: Number(env.AZURE_OPENAI_COMPLETION_TEMPERATURE) || 0.9,
  AZURE_OPENAI_COMPLETION_MAX_TOKENS: Number(env.AZURE_OPENAI_COMPLETION_MAX_TOKENS) || 160,
  AZURE_OPENAI_COMPLETION_FREQUENCY_PENALTY: Number(env.AZURE_OPENAI_COMPLETION_FREQUENCY_PENALTY) || 0,
  AZURE_OPENAI_COMPLETION_PRESENCE_PENALTY: Number(env.AZURE_OPENAI_COMPLETION_PRESENCE_PENALTY) || 0.6,
  AZURE_OPENAI_IMAGE_GENERATION_SIZE: env.AZURE_OPENAI_IMAGE_GENERATION_SIZE || '256x256',
