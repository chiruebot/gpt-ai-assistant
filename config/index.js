...
const config = Object.freeze({
  ...
  OPENAI_COMPLETION_MODEL: env.OPENAI_COMPLETION_MODEL || 'gpt-35-turbo',
  OPENAI_COMPLETION_TEMPERATURE: Number(env.OPENAI_COMPLETION_TEMPERATURE) || 0.7,
  OPENAI_COMPLETION_MAX_TOKENS: Number(env.OPENAI_COMPLETION_MAX_TOKENS) || 2500,
  ...
  OPENAI_COMPLETION_TOP_P: Number(env.OPENAI_COMPLETION_TOP_P) || 0.95,
